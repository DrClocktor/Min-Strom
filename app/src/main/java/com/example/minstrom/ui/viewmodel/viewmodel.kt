...
class ViewModel: ViewModel() {
    ...
    private suspend fun getServiceAccountAccessToken(context: Context): GoogleCredentials? =
        withContext(
            Dispatchers.IO
        ) {
            ...
            try {
                ...
                val inputStream: InputStream =
                    context.assets.open("min-strom-79afb-firebase-adminsdk-fbsvc-3a892562f5.json")
